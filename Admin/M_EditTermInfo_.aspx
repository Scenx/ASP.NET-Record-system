...
<body>
    <form id="form1" runat="server">
        <div class="div_All">
    <div class="Body_Title">学期信息管理 》》编辑学期信息</div>
        <hr />
        <table cellspacing="1" cellpadding="2">
                 <tr>
                   ...
                   学期名称：</td>
                    <td width="650px;">
                         <input id="termName" type="text"   style="width:200px;" runat="server" maxlength="25"/><span class="WarnMes">*</span>请输入学期名称！</td>
                </tr>

                <tr>
                    <td></td>
                    <td>
                        <asp:Button ID="BtnTermInfo_Save" runat="server" Text=" 保存信息 "
