    ...
    <asp:Repeater ID="RpCourse_" runat="server" onitemcommand="RpCourse__ItemCommand">
        ...
        <ItemTemplate>
            <tr>
                ...
                <td align="center"><a href="M_EditCourse_.aspx?courseNo=<%#Eval("courseNo") %>"><img src="Images/MillMes_ICO.gif" alt="修改信息..." /></a><asp:ImageButton class="DelClass" ID="IBDelClass" runat="server" CommandArgument='<%#Eval("courseNo")%>' CommandName="Del" ImageUrl="Images/Delete.gif"  ToolTip="删除该信息..."/></td>
             </tr>
        </ItemTemplate>
